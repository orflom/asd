...
import com.foundstone.s3i.util.ConvertUtil;
import com.foundstone.s3i.util.CurrencyConverter;
import com.foundstone.s3i.util.DateConverter;
...
public class BaseAction extends LookupDispatchAction {
    ...
    /**
     * @see com.foundstone.s3i.util.ConvertUtil#convert(java.lang.Object)
     */
    ...
    /**
     * @see com.foundstone.s3i.util.ConvertUtil#convertLists(java.lang.Object)
     */
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        String add = resources.getMessage(Locale.ENGLISH, "button.add").toLowerCase();
        String delete = resources.getMessage(Locale.ENGLISH, "button.delete").toLowerCase();
        String approve = resources.getMessage(Locale.ENGLISH, "button.approve").toLowerCase();
        String review = resources.getMessage(Locale.ENGLISH, "button.review").toLowerCase();
        String[] rules = {edit, save, search, view, add, delete, approve, review};
