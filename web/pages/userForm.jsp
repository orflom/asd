...
<c:set var="pageButtons">
    ...
    <tr>
        <th>
            <HacmeBooks:label key="userForm.addressForm.address"/>
        </th>
        <td>
    ...
    <tr>
        <th>
            <HacmeBooks:label key="userForm.addressForm.city"/>
        </th>
        <td>
    ...
    <tr>
        <th>
            <HacmeBooks:label key="userForm.addressForm.province"/>
        </th>
        <td>
    ...
    <tr>
        <th>
            <HacmeBooks:label key="userForm.addressForm.country"/>
        </th>
        <td>
            <HacmeBooks:country name="countries" toScope="page"/>
    ...
    <tr>
        <th>
            <HacmeBooks:label key="userForm.addressForm.postalCode"/>
        </th>
        <td>
    ...
    <tr>
        <th>
            <HacmeBooks:label key="userForm.website"/>
        </th>
        <td>
...
<c:choose>
    ...
    <tr>
        <th>
            <HacmeBooks:label key="userForm.roles"/>
        </th>
        <td>
